...
* to a Recipe and was written by an specific User (author)
*
...
class Comment {
	...
	* @param Recipe $post The parent post
	*/
	public function __construct($id=NULL, $content=NULL, User $author=NULL, $post=NULL) {
		$this->id = $id;
	...
	*
	* @return Recipe The parent post of this comment
	*/
	...
	* @return void
	*/
	public function setRecipe(Recipe $post) {
		$this->post = $post;
	}
