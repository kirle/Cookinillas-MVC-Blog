...
<div class="container" id="add_view_container">
	<div id="form-container" class="col-md-8 col-md-offset-2">
		...
		<div class="h1" id="title" >
			<h1><?= i18n("Edit recipe") ?></h1>

		</div>
		<form id="form-add" action="index.php?controller=recipes&amp;action=edit" method="POST" enctype="multipart/form-data">
			...
			<div class="row">
				...
				<div class="form-group center"> 
					...
					<div id="selected-ingredients">
						...
						<?php } else{
							?> 
							<button name="removeIngredientFromRecipe" type="button" class="button button-red glyphicon glyphicon-minus fas fa-camera fa-2x center-block"  
								value="Click here to add" onclick="">
								<input type="hidden" name="ingredient_id_remove" value="
								<?= (isset($ingredient["id"]))?$ingredient["id"]:null ?>">
