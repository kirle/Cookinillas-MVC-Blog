...
class UsersController extends BaseController {
	...
	* <ul>
	* <li>login: The alias (via HTTP POST)</li>
	* <li>passwd: The password (via HTTP POST)</li>
	* </ul>
	*
	* The views are:
	* <ul>
	* <li>recipes/login: If this action is reached via HTTP GET (via include)</li>
	* <li>recipes/index: If login succeds (via redirect)</li>
	...
	public function register() {
		...
		if (isset($_POST["alias"])){ // reaching via HTTP Post...
			...
			try{
				...
				if (!$this->userMapper->aliasExists($_POST["alias"]) && !$this->userMapper->emailExists($_POST["email"])) {
					...
					$this->view->setFlash("userAddedOk");
